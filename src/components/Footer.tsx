  ...
  return (
    <footer className="bg-rosqin-very-light-blue dark:bg-gray-800 py-16" id="contact">
      <div className="container">
        ...
        {/* BOTTOM SECTION: Updated with Privacy Policy link */}
        <div className="border-t border-gray-200 dark:border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-sm text-gray-500 dark:text-gray-400 flex flex-col md:flex-row items-center gap-2">
            <span>© 2025 Rosqin. All rights reserved.</span>
            <a
              href="/privacy-policy.html"
              target="_blank"
              rel="noopener noreferrer"
              className="underline hover:text-rosqin-blue dark:hover:text-rosqin-purple"
            >
              Privacy Policy
            </a>
          </div>
